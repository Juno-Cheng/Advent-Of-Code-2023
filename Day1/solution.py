...
def solution_2(text):
    ...
    for line in split_text: # For each line
        ...
        i = 0
        # Find first digit or number word
        ...
        # Find last digit or number word
        i = 0
        while i < len(line):
            if line[i].isdigit():
                last = line[i]
        ...
        # Add to count if both first and last digits are found
        count += int(str(first)) * 10 + int(str(last))
...
document_text2 = """9dlvndqbddghpxc
...
print("Solution 1: " + solution_2(document_text2))